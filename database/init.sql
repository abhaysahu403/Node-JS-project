...
(1, '2024-06-01', '2024-06-05', 'Vacation', 'APPROVED'),
(2, '2024-06-10', '2024-06-12', 'Medical', 'PENDING'),
(3, '2024-07-01', '2024-07-07', 'Annual Leave', 'APPROVED'),
(4, '2024-06-15', '2024-06-16', 'Personal', 'PENDING'),
(5, '2024-08-01', '2024-08-10', 'Vacation', 'APPROVED');
...
CREATE INDEX idx_app_employee ON applications(applicant_id);
CREATE INDEX idx_leave_emp ON leave_requests(employee_id);
CREATE INDEX idx_ticket_emp ON support_tickets(employee_id);

-- Set Permissions
GRANT ALL PRIVILEGES ON cloud_nexus_hr.* TO 'hr_user'@'%' IDENTIFIED BY 'userpassword';
FLUSH PRIVILEGES;
USE cloud_nexus_hr;
